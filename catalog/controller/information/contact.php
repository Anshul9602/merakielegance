...
class ControllerInformationContact extends Controller {
	...
	public function index() {
		...
		if (($this->request->server['REQUEST_METHOD'] == 'POST') && $this->validate()) {
			...
			// $mail->setTo("anshulkumar969602@gmail.com");
			...
			<body>
			  <p>Here are the Enquiry for Contact</p>
			  <table>
			  <tr>
			...
			<tr>
			  <td style="padding:10px;">'.$this->request->post['name'] .'</td>
			  <td style="padding:10px;">'.$this->request->post['phone'].'</td>
			  <td style="padding:10px;">'.$this->request->post['email'].'</td>
			  <td style="padding:10px;">'.$this->request->post['enquiry'].'</td>
